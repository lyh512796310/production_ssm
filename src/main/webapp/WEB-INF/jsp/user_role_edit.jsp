...
<div style="padding:10px 10px 10px 10px">
	<form id="userRoleEditForm" class="roleForm" method="post">
		...
		<label><input name="permissionOption3" type="checkbox" value="131" />调职申请单新增 </label> 
		<label><input name="permissionOption3" type="checkbox" value="132" />调职申请单修改 </label> 
		<label><input name="permissionOption3" type="checkbox" value="133" />调职申请单删除 </label>  
		<br><br>
		...
		<label><input name="permissionOption3" type="checkbox" value="151" />调职通知单新增 </label> 
		<label><input name="permissionOption3" type="checkbox" value="152" />调职通知单修改 </label> 
		<label><input name="permissionOption3" type="checkbox" value="153" />调职通知单删除 </label>  
		<br><br>
		<span style="font-weight: bold;">离职申请单：</span>
		<label><input name="permissionOption3" type="checkbox" value="161" />离职申请单新增 </label> 
		<label><input name="permissionOption3" type="checkbox" value="162" />离职申请单修改 </label> 
		<label><input name="permissionOption3" type="checkbox" value="163" />离职申请单删除 </label>
		<br><br>
